      ...
      <div className="main-container">
        <section className="Section-1-MainPage">
          ...
          <div className="main-page-container">
                ...
                <source src="/src/assets/background.mp4" type="video/mp4" ></source></video>
            <div className="page-description-container">           
              ...
              <div className="phrase-container">
                <p>
                  Embark on a journey like no other through pristine<br /> 
              ...
              <div className="feature-tours-container">
                <h1>Featured <span className="tours">Tours</span> <span className="font"><FontAwesomeIcon icon={faArrowRight}/> </span>     </h1>
              </div>
            </div>
          </div>
        </section>
